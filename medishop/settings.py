...
# Minimal Django REST framework configuration (expand as needed)
REST_FRAMEWORK = {
...
# CORS: allow frontend dev server to access API during development
# Install packages with: pip install django-cors-headers djangorestframework
